...
export class ChatService {
  ...
  private readonly DEFAULT_SYSTEM_PROMPT = `You are PoungMont, a warm, friendly, and helpful AI companion.
  ...
  async streamMessage(
    ...
    try {
      ...
      // Save messages including reasoning in PostgreSQL
      ...
      // If new conversation has no title, generate a title in the background
      ...
      const errorMessage =
        err?.error?.message || err?.message || 'Error from OpenRouter';
      res.write(
